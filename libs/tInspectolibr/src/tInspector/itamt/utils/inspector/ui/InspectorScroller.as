...
package tInspector.itamt.utils.inspector.ui {
    ...
    public class InspectorScroller extends Sprite {
        ...
        private var _ratio:Number = 0.333333333333333;
        ...
        private function onAdd(evt:Event):void{
            ...
            this.addEventListener(MouseEvent.MOUSE_UP, this.onUpBlock);
        }
        private function onRemove(evt:Event):void{
            ...
            this.removeEventListener(MouseEvent.MOUSE_UP, this.onUpBlock);
            this.stage.removeEventListener(Event.ENTER_FRAME, this.onDrag);
        }
        ...
        public function relayout():void{
            ...
            graphics.endFill();
            var th:Number = (this._h * this._ratio);
            if (th < 6){
                th = 10;
            };
            this._block.upState = this.buildBlockShape(this._w, th, 0x4D4D4D);
            this._block.downState = this.buildBlockShape(this._w, th, 0xFFFFFF);
            this._block.overState = this.buildBlockShape(this._w, th, 0xFFFFFF);
            this._block.hitTestState = this.buildBlockShape(this._w, th, 0x4D4D4D);
        }
        private function onDownBlock(evt:MouseEvent):void{
            this._pMouseY = this._block.mouseY;
            this.stage.addEventListener(Event.ENTER_FRAME, this.onDrag);
        }
        ...
        private function onDrag(evt:Event):void{
            ...
            this._block.y = ty;
            var t:int = Math.round(((this._block.y * this._totalVal) / (this._h - this._block.height)));
            if (this._value != t){
                this._value = t;
