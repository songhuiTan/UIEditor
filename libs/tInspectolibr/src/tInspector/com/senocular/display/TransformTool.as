package tInspector.com.senocular.display {
	...
	import tInspector.itamt.utils.DisplayObjectTool;
	...
	public class TransformTool extends Sprite {
		...
		//silenxiao private ==> public
		public function updateMatrix(useMatrix : Matrix = null, counterTransform : Boolean = true) : void {
			if (_target) {
...
import tInspector.com.senocular.display.TransformTool;
import tInspector.com.senocular.display.TransformToolControl;
import tInspector.com.senocular.display.TransformToolCursor;
